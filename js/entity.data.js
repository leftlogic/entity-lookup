...
n('Alpha', 913, 'greek capital letter alpha, U+0391', ['?', 'a', 'alpha']);
n('Beta', 914, 'greek capital letter beta, U+0392', ['?', 'B', 'beta']);
n('Gamma', 915, 'greek capital letter gamma, U+0393 ISOgrk3', ['G', 'gamma', 'L']);
n('Delta', 916, 'greek capital letter delta, U+0394 ISOgrk3', ['?', 'delta', 'triangle']);
n('Epsilon', 917, 'greek capital letter epsilon, U+0395', ['?', 'e', 'epsilon']);
n('Zeta', 918, 'greek capital letter zeta, U+0396', ['?', 'z', 'zeta']);
n('Eta', 919, 'greek capital letter eta, U+0397', ['?', 'h', 'eta']);
n('Theta', 920, 'greek capital letter theta, U+0398 ISOgrk3', ['T', 'theta', 'o']);
n('Iota', 921, 'greek capital letter iota, U+0399', ['?', 'i', 'iota']);
n('Kappa', 922, 'greek capital letter kappa, U+039A', ['?', 'k', 'kappa']);
n('Lambda', 923, 'greek capital letter lambda, U+039B ISOgrk3', ['?', 'lambda', 'triangle']);
n('Mu', 924, 'greek capital letter mu, U+039C', ['?', 'm', 'mu']);
n('Nu', 925, 'greek capital letter nu, U+039D', ['?', 'n', 'nu']);
n('Xi', 926, 'greek capital letter xi, U+039E ISOgrk3', ['?', 'xi', 'e']);
n('Omicron', 927, 'greek capital letter omicron, U+039F', ['?', 'o', 'omicron']);
n('Pi', 928, 'greek capital letter pi, U+03A0 ISOgrk3', ['?', 'pi']);
n('Rho', 929, 'greek capital letter rho, U+03A1', ['?', 'p', 'rho']);
n('Sigma', 931, 'greek capital letter sigma, U+03A3 ISOgrk3', ['S', 'sigma', 'e']);
n('Tau', 932, 'greek capital letter tau, U+03A4', ['?', 't', 'tau']);
n('Upsilon', 933, 'greek capital letter upsilon, U+03A5 ISOgrk3', ['?', 'upsilon', 'y']);
n('Phi', 934, 'greek capital letter phi, U+03A6 ISOgrk3', ['F', 'o', 'phi']);
n('Chi', 935, 'greek capital letter chi, U+03A7', ['?', 'x', 'chi']);
n('Psi', 936, 'greek capital letter psi, U+03A8 ISOgrk3', ['?', 'y', 'psi']);
n('Omega', 937, 'greek capital letter omega, U+03A9 ISOgrk3', ['O', 'omega', 'o']);
n('alpha', 945, 'greek small letter alpha, U+03B1 ISOgrk3', ['a', 'alpha', 'a']);
n('beta', 946, 'greek small letter beta, U+03B2 ISOgrk3', ['ß', 'b', 'beta']);
n('gamma', 947, 'greek small letter gamma, U+03B3 ISOgrk3', ['?', 'y', 'gamma']);
n('delta', 948, 'greek small letter delta, U+03B4 ISOgrk3', ['d', 'd', 'delta', 'o']);
n('epsilon', 949, 'greek small letter epsilon, U+03B5 ISOgrk3', ['e', 'e', 'epsilon']);
n('zeta', 950, 'greek small letter zeta, U+03B6 ISOgrk3', ['?', 'z', 'zeta']);
n('eta', 951, 'greek small letter eta, U+03B7 ISOgrk3', ['?', 'n', 'eta']);
n('theta', 952, 'greek small letter theta, U+03B8 ISOgrk3', ['?', 'o', 'theta']);
n('iota', 953, 'greek small letter iota, U+03B9 ISOgrk3', ['?', 'i', 'l', 'iota']);
n('kappa', 954, 'greek small letter kappa, U+03BA ISOgrk3', ['?', 'k', 'kappa']);
n('lambda', 955, 'greek small letter lambda, U+03BB ISOgrk3', ['?', 'n', 'lambda', 'y']);
n('mu', 956, 'greek small letter mu, U+03BC ISOgrk3', ['µ', 'u', 'mu']);
n('nu', 957, 'greek small letter nu, U+03BD ISOgrk3', ['?', 'nu', 'v']);
n('xi', 958, 'greek small letter xi, U+03BE ISOgrk3', ['?', 'e', 'xi']);
n('omicron', 959, 'greek small letter omicron, U+03BF NEW', ['?', 'o', 'omicron']);
n('pi', 960, 'greek small letter pi, U+03C0 ISOgrk3', ['p', 'pi']);
n('rho', 961, 'greek small letter rho, U+03C1 ISOgrk3', ['?', 'p', 'o', 'rho']);
n('sigmaf', 962, 'greek small letter final sigma, U+03C2 ISOgrk3', ['?', 'c', 'sigma', 'final']);
n('sigma', 963, 'greek small letter sigma, U+03C3 ISOgrk3', ['s', 'o', 'sigma']);
n('tau', 964, 'greek small letter tau, U+03C4 ISOgrk3', ['t', 't', 'tau']);
n('upsilon', 965, 'greek small letter upsilon, U+03C5 ISOgrk3', ['?', 'u', 'upsilon']);
n('phi', 966, 'greek small letter phi, U+03C6 ISOgrk3', ['f', 'y', 'phi']);
n('chi', 967, 'greek small letter chi, U+03C7 ISOgrk3', ['?', 'x', 'chi']);
n('psi', 968, 'greek small letter psi, U+03C8 ISOgrk3', ['?', 'y', 'psi']);
n('omega', 969, 'greek small letter omega, U+03C9 ISOgrk3', ['?', 'w', 'omega']);
n('thetasym', 977, 'greek small letter theta symbol, U+03D1 NEW', ['?', '0', 'theta']);
n('upsih', 978, 'greek upsilon with hook symbol, U+03D2 NEW', ['?', 'y', 'hook', 'upsilon']);
n('piv', 982, 'greek pi symbol, U+03D6 ISOgrk3', ['?', 'pi']);
...
n('weierp', 8472, 'script capital P = power set = Weierstrass p, U+2118 ISOamso', ['P', 'P', 'power']);
n('image', 8465, 'blackletter capital I = imaginary part, U+2111 ISOamso', ['I', 'blackletter', 'I', 'imaginary']);
n('real', 8476, 'blackletter capital R = real part symbol, U+211C ISOamso', ['R', 'R', 'blackletter', 'real', 'part']);
n('trade', 8482, 'trade mark sign, U+2122 ISOnum', ['™', 'trade', 'mark', 'tm']);
n('alefsym', 8501, 'alef symbol = first transfinite cardinal, U+2135 NEW', ['?', 'alef', 'transfinite', 'n']);
...
n('empty', 8709, 'empty set = null set = diameter, U+2205 ISOamso', ['Ø', 'o', 'empty', 'set', 'null', 'diameter']);
...
n('radic', 8730, 'square root = radical sign, U+221A ISOtech', ['v', 'square', 'root', 'y', '^']);
n('prop', 8733, 'proportional to, U+221D ISOtech', ['?', 'proportional']);
n('infin', 8734, 'infinity, U+221E ISOtech', ['8', 'infinity']);
...
n('cap', 8745, 'intersection = cap, U+2229 ISOtech', ['n', 'intersection', 'cap']);
